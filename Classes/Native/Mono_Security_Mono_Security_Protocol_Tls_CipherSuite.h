...
struct  CipherSuite_t675  : public Object_t
{
	...
	SymmetricAlgorithm_t610 * ___decryptionAlgorithm_17;
...
struct CipherSuite_t675_StaticFields{
	// System.Byte[] Mono.Security.Protocol.Tls.CipherSuite::EmptyArray
	ByteU5BU5D_t108* ___EmptyArray_0;
};
