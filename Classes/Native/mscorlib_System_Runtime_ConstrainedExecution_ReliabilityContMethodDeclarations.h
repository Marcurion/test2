...
extern "C" void ReliabilityContractAttribute__ctor_m6109 (ReliabilityContractAttribute_t1043 * __this, int32_t ___consistencyGuarantee, int32_t ___cer, const MethodInfo* method) IL2CPP_METHOD_ATTR;
