...
struct  ThreadSafeDictionary_2_t361  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t360 * ____valueFactory_1;
	...
	Dictionary_2_t1618 * ____dictionary_2;
};
