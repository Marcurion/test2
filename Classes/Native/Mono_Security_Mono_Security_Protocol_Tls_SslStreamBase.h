...
struct  SslStreamBase_t710  : public Stream_t696
{
	// System.IO.Stream Mono.Security.Protocol.Tls.SslStreamBase::innerStream
	Stream_t696 * ___innerStream_3;
